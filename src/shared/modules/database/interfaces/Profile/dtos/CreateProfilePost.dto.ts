import { ProfilePostINTF, PostVideo } from "../ProfilePost.intf";
...
export class ProfilePostDTO implements ProfilePostINTF{
  ...
  constructor(profilePostINTF: Partial<ProfilePostINTF> = {}) {
    Object.assign(this, profilePostINTF);
