...
import { ProfilePostINTF, PostVideo } from '../interfaces/Profile/ProfilePost.intf';
...
export type Ig_profilePostDocument = Ig_profilePost & Document;

@Schema({timestamps: true})
export class Ig_profilePost implements ProfilePostINTF{
...
export const Ig_profilePostSchema = SchemaFactory.createForClass(Ig_profilePost);